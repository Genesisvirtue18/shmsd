          ...
          {STATS.map((s, index) => {
            ...
            return (
              <StaggerItem key={s.label} className="h-full">
                <div className="flex h-full min-w-0 flex-col items-center gap-2 rounded-sm md:rounded-2xl border border-border bg-card p-3 text-center shadow-lg shadow-primary/5 sm:flex-row sm:items-center sm:gap-4 sm:p-5 sm:text-left">
