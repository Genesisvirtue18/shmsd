...
import { DepartmentsCarousel } from '@/components/home/departments-carousel'
    ...
    <>
      ...
      <section className="bg-muted px-6 py-16 sm:py-24">
        <div className="mx-auto max-w-7xl">
          ...
          />
          <StaggerGroup className="mt-14 grid gap-6 grid-cols-2 lg:grid-cols-3">
            {WHY_CHOOSE.map((w) => (
              <StaggerItem key={w.title} className="h-full">
                <div className="flex-col md:flex h-full gap-4 rounded-2xl border border-border bg-card p-6 shadow-sm transition-all hover:-translate-y-1 hover:shadow-lg">
                  <span className="flex h-8 w-8 md:w-12 md:w-12 shrink-0 items-center justify-center rounded-xl bg-primary/10 text-primary">
                    <Icon name={w.icon} className="h-4 w-4 md:h-6 md:w-6" aria-hidden />
                  </span>
                  <div>
      ...
      <section className="px-6 py-16 sm:py-24">
        <div className="mx-auto max-w-7xl">
          ...
          <div className="mt-10 lg:hidden">
            <DepartmentsCarousel departments={DEPARTMENTS.slice(0, 4)} />
          </div>
          <StaggerGroup className="mt-14 hidden gap-6 lg:grid lg:grid-cols-4">
